...
export default function AddEdite() {
    const location = useLocation();
    const data ={username: '', email: '',password:'',password2:'',Opital:"",commune:"",typeuser:"",fileData:""}  //location?.state;
    const [file, setFile] = useState();
    //     setFile(URL.createObjectURL(e.target.files[0]));
    const navigate=useNavigate();
    const [divData, setdivData] = useState({username: '', email: '',password:'',password2:'',Opital:"",commune:"",typeuser:"",fileData:""});
...
<div   className="flex flex-row w-3/4 shadow-md bg-blue-50 px-8 pt-6 pb-8 mb-4 my-2 ml-40 mt-10">
   <div  className="bg-blue-50 w-3/4 rounded  flex flex-col mr-2">
   <div className="-mx-3 md:flex mb-1">
    ...
    <div className="-mx-3 md:flex mt-6 mb-1">
        ...
        {loading?(<span>Ajouter Compte Utilisateur..</span>):(<span>Ajouter Compte Utilisateur</span>)}
        </button>
    </div>
    ...
    <div className="bg-blue-50 w-96  rounded px-4 pt-6 pb-8 mb-4 flex flex-col my-2 ml-0 mt-1">
