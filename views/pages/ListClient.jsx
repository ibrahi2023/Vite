...
import DataTabl from "../components/TableClient.jsx";
...
const ListPageClient = () => {
    ...
    return (
        <HeaderChild>
        { Datauser.length>0 ? (<DataTabl data={{user:data,result:Datauser}} />):(<><div className="flex-rowg col-span-3 text-center mt-48" role="status">
