...
import DataTabletd from "../components/Table.jsx";
...
const ListPage = () => {
    ...
    return (
        <PageChild>
        { Datauser.length>0 ? (<DataTabletd data={{user:data,result:Datauser}} />):(<><div className="flex-rowg col-span-3 text-center mt-48" role="status">
